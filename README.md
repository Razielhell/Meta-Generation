...
<table>
  <tr align="center">
   ...
   <tr align="center">
    ...
    <td><h4>This subdirectory contains all of the project's prefabs,which are reusable
	    
	    game objects that can be used to quickly add functionality to a scene.</h4></td>
